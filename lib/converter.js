...
class converter {
    ...
    fetchArguments(node) {
        let helpers = new Node(node)
        return {
            firstArg : helpers.NODE_ARGS[0].params[0] ? helpers.NODE_ARGS[0].params[0].name : null,//node.arguments[0].params[0] ? node.arguments[0].params[0].name : null,
            secondArg : helpers.NODE_PARAMS[1] ? helpers.NODE_PARAMS[1].name : null,
            thirdArg : helpers.NODE_PARAMS[2] ? helpers.NODE_PARAMS[2].name : null
        }
    }
